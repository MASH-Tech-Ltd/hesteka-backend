...
router.use("/community/chat", chatLimiter, chatRoute);
router.use("/community/chat", chatLimiter, chatLikeRoute);
...
router.use("/community/private", chatLimiter, privateChatRoute);

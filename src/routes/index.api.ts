...
import { crowdfundingRoute } from "../modules/crowdfunding/crowdfunding.route";
...
router.use("/community/chat", communityLimiter, chatRoute);
router.use("/community/chat", communityLimiter, chatLikeRoute);
...
router.use("/crowdfunding", crowdfundingRoute);
router.use("/community/private", communityLimiter, privateChatRoute);
